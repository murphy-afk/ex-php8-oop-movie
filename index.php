...
class Movie
{
  ...
  function __construct($_title, $_description, $_releaseYear, $_duration, Genre $_genre)
  {
    $this->title = $_title;
...
$theMatrix = new Movie('The Matrix', 'A hacker discovers the truth about reality.', 1999, 136, $scienceFiction);
$interstellar = new Movie('Interstellar', 'A team travels through a wormhole to save humanity.', 2014, 169, $scienceFiction);
...
<body>
  ...
  echo $movie->title . ' - ' . $movie->genre->name . ' - ' . $movie->description .' - ' . $movie->releaseYear . ' - ' . ($movie->isLongMovie() ? 'over two hours long' : 'under two hours long') . "<br>";
}
